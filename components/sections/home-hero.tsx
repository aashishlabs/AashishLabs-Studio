  ...
  return (
    <section className="relative overflow-hidden">
      <div className="container grid items-center gap-8 py-10 md:min-h-[calc(100svh-4.5rem)] md:grid-cols-[1.05fr_0.95fr] md:gap-10 md:py-24">
        ...
        <Reveal delay={0.12}>
          <div className="relative mx-auto w-full max-w-xl overflow-hidden rounded-lg border border-[hsl(var(--subtle-border))] bg-card p-3 shadow-glow md:aspect-[4/3] md:p-4">
            ...
            <div className="relative grid h-full grid-rows-[auto_1fr_auto] gap-2 md:gap-4">
              <div className="flex items-center justify-between rounded-md border border-[hsl(var(--subtle-border))] bg-background/70 p-2.5 md:p-3">
              ...
              <div className="grid grid-cols-2 gap-2 md:gap-3">
                {siteConfig.home.hero.preview.map((item) => (
                  <div key={item.title} className="rounded-md border border-[hsl(var(--subtle-border))] bg-background/60 p-3 md:p-4">
              ...
              <div className="rounded-md border border-[hsl(var(--subtle-border))] bg-background/70 p-2.5 text-xs leading-5 text-muted-foreground md:p-3 md:text-sm">
