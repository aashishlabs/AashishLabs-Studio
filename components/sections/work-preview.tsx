  ...
  return (
    <div>
        ...
        {items.map((item) => (
          ...
          >
            ...
            <div className="p-5 md:p-6">
              ...
              <h3 className="mt-4 flex items-start justify-between gap-4 font-display text-xl font-semibold md:text-2xl">
                {item.title}
                <ArrowUpRight
                  className="mt-1 h-5 w-5 shrink-0 text-primary transition-transform group-hover:translate-x-0.5 motion-reduce:transform-none"
                  aria-hidden="true"
                />
              </h3>
      ...
      {featured && (
        <Link
          href="/work"
          className="focus-ring mt-5 inline-flex min-h-11 items-center gap-2 rounded-sm text-sm font-semibold text-primary"
        >
          Explore all work
