...
export function MobileActionBar() {
  return (
    <div aria-label="Quick contact" role="region" className="mobile-action-bar fixed inset-x-0 bottom-0 z-40 border-t border-border bg-background/95 px-3 py-3 backdrop-blur-xl sm:hidden">
