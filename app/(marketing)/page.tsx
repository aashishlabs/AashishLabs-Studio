    ...
    <MainLayout>
      <main>
        ...
        <section id="services" className="container py-12 md:py-16">
          ...
          <div className="mt-7 md:mt-9"><ServicesGrid /></div>
        </section>
        <WhyAashishLabs />
        <section id="process" className="container py-12 md:py-16">
          <SectionHeading eyebrow="How we work" title="Clear steps. Shared direction."
            description="From the first conversation to what comes after launch. Explore each step." />
          <div className="mt-7 md:mt-9"><ProcessTimeline /></div>
        </section>
        <section id="faq" className="container grid gap-7 py-12 md:py-16 lg:grid-cols-[0.8fr_1.2fr] lg:gap-16">
          <SectionHeading eyebrow="A few good questions" title="Start with clarity."
