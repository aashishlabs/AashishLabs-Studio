    ...
    <MainLayout>
      ...
      <main className="service-detail">
        ...
        <section className="container page-section">
          ...
          <div className="service-outcomes mt-8 grid gap-4 md:grid-cols-3">
        ...
        <section className="container page-section grid gap-10 lg:grid-cols-2">
          <div>
            <SectionHeading
              eyebrow="Included"
              title="A practical scope shaped around your goals"
            />
            <div className="service-includes mt-8 grid gap-3">
              {service.includes.map((item) => (
                <div
                  key={item}
                  className="rounded-md border border-white/10 bg-card/70 p-4 text-sm font-medium"
                >
                  {item}
                </div>
              ))}
          ...
          <div>
            ...
            <Accordion type="single" collapsible className="service-faq mt-6">
        ...
        <section className="container page-section" data-mobile-action-guard>
          <Card className="service-final-card bg-primary text-primary-foreground">
